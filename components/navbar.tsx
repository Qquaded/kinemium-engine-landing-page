    ...
    >
      ...
      >
        ...
        <a href="#" className="flex items-center gap-2">
          ...
          <span className="font-semibold text-white hidden sm:block">{siteConfig.name}</span>
        </a>
        ...
        <div className="hidden md:flex items-center gap-3">
          <Button
            asChild
            size="sm"
            className="shimmer-btn bg-orange-500 text-white hover:bg-orange-600 rounded-full px-4"
          >
      ...
      {mobileMenuOpen && (
        ...
        >
          <div className="flex flex-col gap-2">
            ...
            <Button asChild className="shimmer-btn bg-orange-500 text-white hover:bg-orange-600 rounded-full">
