      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        >
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-zinc-500 mb-4">{siteConfig.tagline}</p>
            {/* License Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-zinc-900 border border-zinc-800">
              ...
              <span className="text-xs text-zinc-400">{siteConfig.footer.license}</span>
            </div>
          </div>
        ...
        >
          <p className="text-sm text-zinc-500">{siteConfig.footer.copyright}</p>
          <div className="flex items-center gap-6">
            <a href={siteConfig.links.github} className="text-sm text-zinc-500 hover:text-white transition-colors">
              GitHub
            </a>
            <a href={siteConfig.links.discord} className="text-sm text-zinc-500 hover:text-white transition-colors">
              Discord
            </a>
          </div>
        </motion.div>
